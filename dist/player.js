/*! @vimeo/player v2.0.1-nofullscreen-1 | (c) 2017 Vimeo | MIT License | https://github.com/vimeo/player.js */
        ...
        var readyPromise = new npo_src(function (resolve, reject) {
            ...
            if (_this.element.nodeName !== 'IFRAME') {
                ...
                getOEmbedData(url, params).then(function (data) {
                    ...
                    fsAttributes.forEach(function (attr) {
                        return iframe.attributes.removeNamedItem(attr);
                    });
        ...
        value: function callMethod(name) {
            ...
            return new npo_src(function (resolve, reject) {
                ...
                return _this2.ready().then(function () {
                    ...
                    postMessage$1(_this2, name, args);
                });
            });
        }
